...
class Middleware {
  /**
   * @property {[URL]} middlewares - посилання на ланцюжок оброблення повыдомлень
   */
  #middlewares;

  /**
   * @property {function} callback - колбек
   */
  #callback;

  /**
   * створює екземпляр масива посилань на ланцюжок оброблення повідомлень
   * @param callback - примірник amqp-manager {@link callback}
   * */
